...
static bool faitShapeFuncRegistered = false;

void faitInitNNCShapeFunc() {
  if (faitShapeFuncRegistered) return;
  faitShapeFuncRegistered = true;
  shapeFuncs.insert({
