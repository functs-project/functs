...
static bool faitInitCanonicalizeOpsRegistered = false;
void faitInitCanonicalizeOps() {
  if (faitInitCanonicalizeOpsRegistered) return;
  faitInitCanonicalizeOpsRegistered = true;
  rewriteFuncs.insert({
